 ...
 * @param {Object} res - The http response
 */
<span class="fstat-no" title="function not covered" >function defaultJsonErrorResponder(err, res) {</span>
...
<span class="cstat-no" title="statement not covered" >            return defaultJsonErrorResponder(err, res);</span>
          }

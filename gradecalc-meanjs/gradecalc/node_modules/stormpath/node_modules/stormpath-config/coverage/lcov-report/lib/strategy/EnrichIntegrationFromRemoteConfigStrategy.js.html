...
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (!config.socialProviders) {
...
&nbsp;
              <span class="missing-if-branch" title="else path not taken" >E</span>if (!localProvider.callbackUri) {

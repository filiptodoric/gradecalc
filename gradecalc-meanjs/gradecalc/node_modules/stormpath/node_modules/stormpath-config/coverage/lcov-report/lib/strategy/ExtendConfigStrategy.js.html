...
&nbsp;
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if(this.extendWith &amp;&amp; this.extendWith.web &amp;&amp; <span class="branch-2 cbranch-no" title="branch not covered" >this.extendWith.web.produces)</span>{
<span class="cstat-no" title="statement not covered" >    config.web.produces = this.extendWith.web.produces;</span>
  }
&nbsp;
